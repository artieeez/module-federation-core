...
class ContainerPlugin {
    ...
    apply(compiler) {
        ...
        compiler.hooks.make.tapAsync(PLUGIN_NAME, (compilation, callback) => {
            ...
            //@ts-ignore
            exposes, shareScope, federationRuntimePluginInstance.entryFilePath, this._options.experiments);
            dep.loc = { name };
        ...
        compiler.hooks.thisCompilation.tap(PLUGIN_NAME, (compilation, { normalModuleFactory }) => {
            ...
            compilation.addInclude(compiler.context, federationRuntimeDependency, { name: undefined }, (err, module) => {
                if (err) {
                    return logger.error('Error adding federation runtime module:', err);
                }
