...
export interface RemoteScope {
    [index: string]: AsyncContainer | string | undefined | Record<string, string> | SharedScope | ModuleFederationRuntime;
    _config: Record<string, string>;
    __sharing_scope__?: SharedScope;
    _runtime?: ModuleFederationRuntime;
}
export interface IRemoteScriptFactory {
    loadScript: (containerKey: string, remoteOptions: RemoteOptions) => AsyncContainer;
}
